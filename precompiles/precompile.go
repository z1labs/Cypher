...
func Precompiles() map[addr]ArbosPrecompile {
	...
	// FheLibPrecompileImpl := &FheLibPrecompile{Address: types.FheLibAddress}
	// FheAddress, FheLunPrecimpoileMake := MakePrecompile(pgen.FheLibMetaData, FheLibPrecompileImpl)
	// insert(FheAddress, FheLunPrecimpoileMake)
